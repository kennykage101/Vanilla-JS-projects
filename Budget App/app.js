...
var UIController = (function(){
    ...
    return{
        ...
        clearFields: function(){
            ...
            // QuerySelectorAll is useful to select more than one element at once but the issue is that it creates a list instead of an array//
            fields = document.querySelectorAll(DOMstrings.inputDescription + ',' + DOMstrings.inputValue);

            // We can change the list into an array by using the Array.prototype.slice() method by tricking it to believe it is an array not a list. We then call the list using the call() method.
            fieldsArr = Array.prototype.slice.call(fields);

            // the forEach() method is also used to loop an array
...
var controller = (function(budgetCtrl, UICtrl){
        ...
        // To create an event when the Enter key is pressed
    ...
    var ctrlAddItem = function(){
        ...
        // thr isNaN() method is used to check whether a number is a number or NaN
        ...
        var ctrlDeleteItem = function(event){
            ...
            // This method is called DOM traversing whereby we move up the DOM from the target element using the parentNode property
